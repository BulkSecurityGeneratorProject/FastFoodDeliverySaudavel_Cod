...
public class ClienteResourceIntTest {
    ...
    private static final BigDecimal DEFAULT_CALORIAS = new BigDecimal(1);
    private static final BigDecimal UPDATED_CALORIAS = new BigDecimal(2);
    ...
    public void createCliente() throws Exception {
        ...
        assertThat(testCliente.getPeso()).isEqualTo(DEFAULT_PESO);
        assertThat(testCliente.getAltura()).isEqualTo(DEFAULT_ALTURA);
        assertThat(testCliente.getCalorias()).isEqualTo(DEFAULT_CALORIAS);
    }
    ...
    public void getAllClientes() throws Exception {
        ...
        restClienteMockMvc.perform(get("/api/clientes?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].calorias").value(hasItem(DEFAULT_CALORIAS.intValue())));
    }
    ...
    public void getCliente() throws Exception {
        ...
        restClienteMockMvc.perform(get("/api/clientes/{id}", cliente.getId()))
            ...
            .andExpect(jsonPath("$.calorias").value(DEFAULT_CALORIAS.intValue()));
    }
    ...
    public void updateCliente() throws Exception {
        ...
        Cliente testCliente = clienteList.get(clienteList.size() - 1);
        assertThat(testCliente.getPeso()).isEqualTo(UPDATED_PESO);
        assertThat(testCliente.getAltura()).isEqualTo(UPDATED_ALTURA);
        assertThat(testCliente.getCalorias()).isEqualTo(UPDATED_CALORIAS);
    }
